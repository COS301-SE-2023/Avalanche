    ...
    */
    ...
    return <>
        <div className="mr-5 mb-4 border-b border-gray-200 dark:border-gray-700">
            ...
            <li className={"inline-block p-2 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 text-blue-600 hover:text-blue-600 dark:text-blue-500 dark:hover:text-blue-400 border-blue-600 dark:border-blue-500"} role="presentation">
        ...
        <div className={' p-4 rounded-lg bg-gray-50 dark:bg-primaryBackground overflow-x-hidden overflow-y-scoll max-h-[calc(100vh-11rem)]'} role="tabpanel">
                    <HeraTab permissionData={stateHera.hera.data}></HeraTab> 
                </div>
        </div>
    </>
}