...
export default function ChartCard({ title, data, defaultGraph }: IChartCard) {
    ...
    return (<>
        ...
        {
            magnifyModal && <div className="p-0 md:p-4 absolute top-0 left-0 right-0 overflow-x-hidden overflow-y-auto md:inset-0 flex justify-center items-center bg-slate-900/50" onClick={() => { handleMagnifyModal(false) }}>
