...
export default function DomainNameAnalysis() {
    ...
    useEffect(() => {
        ...
        const ageAnalysisTop5: IDomainNameAnalysisGraphRequest = {granularity : 'week', num : 1, minimumAppearances: 10};
        ...
        const ageAnalysisTop10: IDomainNameAnalysisGraphRequest = {granularity : 'week', num : 3, minimumAppearances: 150};
    ...
    return (<>
        ...
        <div className="p-4 sm:ml-64 bg-gray-100 dark:bg-secondaryBackground min-h-screen">
            <div className="flex justify-between items-center">
                <PageHeader title="Domain Name Analysis" subtitle="Insights at your fingertips" icon={<HomeIcon className="h-16 w-16 text-black dark:text-white" />} />
            </div>
