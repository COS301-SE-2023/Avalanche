...
export default function Registrar() {
    ...
    function loadData(){
        ...
        const monthlyLastYear: ITransactionGraphRequest = { zone: ["CO.ZA"], registrar: ["Individual"], graphName: `Monthly\n from ${dateFrom} to ${dateTo}`, granularity: "month", dateFrom, dateTo };
        ...
        const monthlyPastYear: ITransactionGraphRequest = { zone: ["CO.ZA"], registrar: ["Individual"], graphName: `Monthly\n from ${dateFrom} to ${dateTo}`, granularity: "month", dateFrom, dateTo };
        ...
        const yearlyPastFive: ITransactionGraphRequest = { zone: ["CO.ZA"], registrar: ["Individual"], graphName: `Yearly\n from ${dateFrom} to ${dateTo}`, granularity: "year", dateFrom, dateTo };
        ...
        dateTo = `${currentDate.getFullYear()}-${pad(currentDate.getMonth())}-${pad(currentDate.getDate())}`;
        const weeklyThreeMonths: ITransactionGraphRequest = { zone: ["CO.ZA"], registrar: ["Individual"], graphName: `Weekly\n from ${dateFrom} to ${dateTo}`, granularity: "week", dateFrom, dateTo };
        ...
        dateTo = `${currentDate.getFullYear()}-${pad(currentDate.getMonth())}-${pad(currentDate.getDate())}`;
        const dailyTwoWeeks: ITransactionGraphRequest = { zone: ["CO.ZA"], registrar: ["Individual"], graphName: `Daily\n from ${dateFrom} to ${dateTo}`, granularity: "day", dateFrom, dateTo };
