    ...
    return (<>
        ...
        <MainContent>
            <div className="flex justify-between items-center">
                <PageHeader title="Registrar Market Comparison" subtitle="Compare top registrars based on their recent performance" icon={<MapIcon className="h-16 w-16 text-black dark:text-white" />} />
