...
describe('UserManagementService (Integration)', () => {
  ...
  describe('register', () => { //issue with DB, deleting user from DB cuz othweiser fucky
    ...
    it('should fail as there is no firstName', async () => {
      const data = {lastName: 'Doe2', email: 'john2@example.com', password : "yes"};
    ...
    it('should fail as there is no email', async () => {
      const data = {firstName: 'Doe2', lastName: 'john2@example.com', password : "yes"};
