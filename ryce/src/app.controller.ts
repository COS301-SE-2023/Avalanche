...
export class AppController {
  ...
  async transactionsRanking(data: any) {
    console.log('Transactions: ', data);
    return await this.transactionsService.transactionsRanking(
      data.filters,
      data.graphName,
    );
  }
  ...
  async marketShare(data: any) {
    return await this.marketShareService.marketShare(
      data.filters,
      data.graphName,
    );
  }
  ...
  async domainNameAnalysisLength(data: any) {
    return await this.domainNameAnalysisService.domainLength(
      data.filters,
      data.graphName,
    );
  }
