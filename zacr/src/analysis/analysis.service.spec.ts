...
describe('AnalysisService', () => {
  ...
  it('should throw error for data with less than two columns', async () => {
    ...
    await expect(service.analyze(data)).rejects.toThrow('Data should have at least two columns');
  });
  ...
  //   expect(parsedResult.series1).toHaveProperty('data');
  //   expect(parsedResult.series1).toHaveProperty('summary');
  // });
